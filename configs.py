...
def add_args(parser):
    parser.add_argument("--task", type=str,
                        choices=['repair', 'concode', 'translate', 'refine', 'refine_aug', 'review_aug', 'multi_task', 'review'])
    ...
    parser.add_argument("--do_zero_shot", action='store_true', help="Whether to evaluate zero-shot inference on test set.")
    ...
    if args.task in ['summarize', 'edit_CSN', 'CSN', 'skeleton']:
        args.lang = args.sub_task
    elif args.task in ['refine', 'refine_aug', 'review_aug', 'review']:
        args.lang = 'java'
