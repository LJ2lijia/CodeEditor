...
def eval_bleu_epoch(args, eval_data, eval_examples, model, tokenizer, split_tag, criteria):
            ...
            if args.model_type == 'roberta':
                ...
                if args.n_gpu > 1:
                    preds = model.module.generate(source_ids,
                                        ...
                                        early_stopping=(args.task == 'skeleton' or args.task == 'edit_CSN'),
    ...
    if args.task in ['defect']:
        ...
        #     if args.task in ['concode', 'translate', 'refine', 'edit_CSN', 'skeleton']:
...
def main():
    ...
    if args.n_gpu > 1:
        ...
        args.eval_batch_size = args.train_batch_size // args.n_gpu
    ...
    if args.do_test:
        ...
        for criteria in ['best-bleu']:
            ...
            eval_examples, eval_data = load_and_cache_gen_data(args, args.test_filename, pool, tokenizer, 'test_{}'.format(criteria),
                                                               only_src=True, is_sample=False)
            
                
            result = eval_bleu_epoch(args, eval_data, eval_examples, model, tokenizer, 'test_{}'.format(criteria), criteria)
